...
<div className="mb-5" id="competence">
                ...
                <div className="col-sm-3 mb-3 mb-sm-0 ">
                    <div className="card shadow">
                        <div className="card-body">
                            ...
                            <MdAddAPhoto className="fs-2 text-info mb-5" />
                            
                            <h5 className="card-text mbicone4-2 fw-bold">Photographie et Cadrage </h5>
                ...
                <div className="col-sm-3 mb-3 mb-sm-0">
                    <div className="card shadow">
                        <div className="card-body">
                            ...
                            <p className="text-secondary">Flexibilité et réactivité pour répondre à vos besoins en création graphique, photo et vidéo à tout moment.</p>
                        </div>
                    </div>
                </div>
            </div>
